...
@Injectable()
export class SentMessageListResolverService implements Resolve<UserMessageClient[]> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> {
        ...
        var apiLocation = `api/AppUserManager/user/getSentMsgList`
...
//SentMessageListResolverService