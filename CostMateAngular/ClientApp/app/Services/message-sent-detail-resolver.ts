...
@Injectable()
export class MessageSentDetailResolverService implements Resolve<UserMessageClient> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> {
        ...
        if (isNaN(id)) {
            ...
            this.router.navigate(['/dashboard/message/received']) //change this url
        ...
        var apiLocation = `api/AppUserManager/user/getSpecificSentMsg/${+id}`
